...
const CalendarCarousel = ({ calendarItems }) => {
  ...
  }, [calendarItems.length, isPlaying, isFullscreen]);
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <div className="w-full md:w-2/5 lg:w-1/3 mx-auto">
        {/* Contenedor con proporción 9:16 */}
          ...
          <div className="absolute inset-0">
            {calendarItems.map((item, index) => (
              <div
                ...
                aria-label={`Slide ${index + 1} of ${calendarItems.length}`}
              >
                <img
                  src={item.image}
                  alt={item.title}
